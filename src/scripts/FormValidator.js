export class FormValidator {
    constructor(validateObject, validateElementSelector) {
        this._validateObject = validateObject;
        this._validateElementSelector = document.querySelector(validateElementSelector);
        this._formElement = this._validateElementSelector.querySelector(validateObject.formSelector);
    ...
    removeValidationErrors(){
        ...
        Array.from(this._validateElementSelector.querySelectorAll(this._validateObject.inputSelector)).forEach((element) => {
            element.classList.remove(this._validateObject.inputErrorClass);
        });
        Array.from(this._validateElementSelector.querySelectorAll(this._validateObject.spanSelector)).forEach((element) => {
