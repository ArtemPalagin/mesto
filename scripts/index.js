...
function renderPlaces(link, name, selector) {
...
function savePlacesData(e) {
  e.preventDefault();
  renderPlaces(popupPlacesLink.value, popupPlacesName.value, "#card-template");
...
initialCards.forEach(function (item) {
  renderPlaces(item.link, item.name, "#card-template");
});
