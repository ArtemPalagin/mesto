...
let popupProfileUsername = popupProfile.querySelector(".popup__entry_username_profile");
let popupProfileHimself = popupProfile.querySelector(".popup__entry_himself_profile");
...
let popupPlacesName = popupPlaces.querySelector(".popup__entry_name_places");
let popupPlacesLink = popupPlaces.querySelector(".popup__entry_link_places");
